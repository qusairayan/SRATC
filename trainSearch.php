...
if (isset($_GET['from'],  $_GET['to']) ) {
	...
	$_SESSION['date'] = $_GET['date'];
				   ...
				   $sql = "SELECT * FROM Trip WHERE From_station = '$from' AND TO_station = '$to' AND  Date='$date' AND BID IS NULL ";
...
<div class="navbar">
  ...
  <a href="#">Contact us <i style="font-size:24px;   transform: rotate(250deg);" class="fa">&#xf095;</i> </a>
